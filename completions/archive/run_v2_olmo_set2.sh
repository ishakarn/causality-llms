#!/bin/bash
#SBATCH --job-name=compl-v2-olmo-s2
...
#SBATCH --output=completions/slurm_logs/%j_v2_olmo_set2.out
#SBATCH --error=completions/slurm_logs/%j_v2_olmo_set2.err
...
python completions/v2_completions_test_olmo_set2.py

echo "=== Done: OLMo-3.1-32B v2 completions audit set2 ==="
