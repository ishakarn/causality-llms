...
_MODEL_CONFIGS = {
    "olmo32b": ("allenai/Olmo-3.1-32B-Instruct", "completions/outputs/olmo3132binstruct_v2_audit.txt", True),
    "gptoss":  ("openai/gpt-oss-20b",             "completions/outputs/gptoss20b_v2_audit.txt",         False),
}

_model_key = os.environ.get("MODEL", "olmo32b")
...
def load_model_and_tokenizer():
    ...
    return tokenizer, model, None  # device managed by device_map
...
def build_model_inputs(tokenizer, device, visible_text):
    ...
    For base models (USE_CHAT_TEMPLATE=False), raw text is tokenized directly.
    """
    ...
    return model_inputs.to("cuda" if torch.cuda.is_available() else "cpu")
