...
OUTPUT_FILE = "completions/outputs/olmo3132binstruct_full_audit_set3.txt"
...
prefix = "{\"question_id\": 5607, \"desc_id\": \"encouagement_program-mediation-nie-model503-spec23-q1\", \"given_info\": \""
full_prompt = "{\"question_id\": 5607, \"desc_id\": \"encouagement_program-mediation-nie-model503-spec23-q1\", \"given_info\": \"For students who are not encouraged and do not study hard, the probability of high exam score is 28%. For students who are not encouraged and study hard, the probability of high exam score is 58%. For students who are encouraged and do not study hard, the probability of high exam score is 54%. For students who are encouraged and study hard, the probability of high exam score is 90%. For students who are not encouraged, the probability of studying hard is 32%. For students who are encouraged, the probability of studying hard is 79%. Does encouragement level negatively affect exam score through studying habit?"
