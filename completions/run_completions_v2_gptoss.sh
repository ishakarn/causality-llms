#!/bin/bash
#SBATCH --job-name=completions-v2-gptoss
...
#SBATCH --output=completions/slurm_logs/%j_completions_v2_gptoss.out
#SBATCH --error=completions/slurm_logs/%j_completions_v2_gptoss.err
...
MODEL=gptoss python completions/completions_test_opensource_models_v2.py

echo "=== Done: GPT-OSS-20B v2 completions audit ==="
