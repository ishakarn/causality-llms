#!/bin/bash
#SBATCH --job-name=completions-gptoss
...
#SBATCH --output=completions/slurm_logs/%j_completions_gptoss.out
#SBATCH --error=completions/slurm_logs/%j_completions_gptoss.err
...
MODEL=gptoss python completions/completions_test_opensource_models.py

echo "=== Done: GPT-OSS-20B completions audit ==="
