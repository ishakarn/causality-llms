#!/bin/bash
#SBATCH --job-name=compl-v2-gptoss-s2
...
#SBATCH --output=completions/slurm_logs/%j_v2_gptoss_set2.out
#SBATCH --error=completions/slurm_logs/%j_v2_gptoss_set2.err
...
python completions/v2_completions_test_gpt_oss_20b_set2.py

echo "=== Done: GPT-OSS-20B v2 completions audit set2 ==="
