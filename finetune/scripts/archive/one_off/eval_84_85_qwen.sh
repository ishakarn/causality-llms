#!/bin/bash
# Eval 84_symbolic_partial + 85_symbolic_full for qwen3b base + lora.

#SBATCH --job-name=84-85-qwen
...
#SBATCH --output=finetune/slurm_logs/%j_84_85_qwen.out
#SBATCH --error=finetune/slurm_logs/%j_84_85_qwen.err
