#!/bin/bash
# Eval 82_polarity_flip + 83_story_swap_polarity_flip for gptoss base only.

#SBATCH --job-name=82-83-gptoss
...
#SBATCH --output=finetune/slurm_logs/%j_82_83_gptoss.out
#SBATCH --error=finetune/slurm_logs/%j_82_83_gptoss.err
