#!/bin/bash
# Eval 86_nonsense_replace for gptoss base only (easy/hard/anticommonsense).

#SBATCH --job-name=86-gptoss
...
#SBATCH --output=finetune/slurm_logs/%j_86_gptoss.out
#SBATCH --error=finetune/slurm_logs/%j_86_gptoss.err
...
echo "=== Done: 86_nonsense_replace for gptoss ==="
