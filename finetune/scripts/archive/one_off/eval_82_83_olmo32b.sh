#!/bin/bash
# Eval 82_polarity_flip + 83_story_swap_polarity_flip for olmo32b base + lora.

#SBATCH --job-name=82-83-olmo32b
...
#SBATCH --output=finetune/slurm_logs/%j_82_83_olmo32b.out
#SBATCH --error=finetune/slurm_logs/%j_82_83_olmo32b.err
...
INTERVENTIONS=(82_polarity_flip 83_story_swap_polarity_flip)
SPLITS=(easy hard)
