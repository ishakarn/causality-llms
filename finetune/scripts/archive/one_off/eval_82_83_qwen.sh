#!/bin/bash
# Eval 82_polarity_flip + 83_story_swap_polarity_flip for qwen3b base + lora.

#SBATCH --job-name=82-83-qwen
...
#SBATCH --output=finetune/slurm_logs/%j_82_83_qwen.out
#SBATCH --error=finetune/slurm_logs/%j_82_83_qwen.err
