#!/bin/bash
# Eval 84_symbolic_partial + 85_symbolic_full for gptoss base only.

#SBATCH --job-name=84-85-gptoss
...
#SBATCH --output=finetune/slurm_logs/%j_84_85_gptoss.out
#SBATCH --error=finetune/slurm_logs/%j_84_85_gptoss.err
