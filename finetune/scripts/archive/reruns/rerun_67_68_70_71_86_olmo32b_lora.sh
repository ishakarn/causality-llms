#!/bin/bash
# Re-run 67/68/70/71/86 for olmo32b LORA ONLY on updated intervention files.

#SBATCH --job-name=rerun-olmo32b-lora
...
#SBATCH --output=finetune/slurm_logs/%j_rerun_olmo32b_lora.out
#SBATCH --error=finetune/slurm_logs/%j_rerun_olmo32b_lora.err
...
ADAPTER="finetune/checkpoints/graded/${COND_TAG}/final_adapter"
...
echo "=== Done: 67/68/70/71/86 rerun olmo32b lora ==="
