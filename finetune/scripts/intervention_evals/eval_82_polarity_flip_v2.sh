#!/bin/bash
# Submission driver for: 82_polarity_flip
# Splits: easy hard
# Usage: bash finetune/scripts/intervention_evals/eval_82_polarity_flip_v2.sh

TEMPLATES=$(dirname "$0")
WORKDIR=${WORKDIR:-$(cd "$(dirname "$0")/../.."; pwd)}
cd "$WORKDIR"

export INTERV_NAME="82_polarity_flip"
export SPLITS_LIST="easy hard"

JOB_NAME="82_polarity_flip"
