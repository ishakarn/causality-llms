#!/bin/bash
# Submission driver for: 22_insert_wrong_answer_once_per_sentence
# Splits: easy hard anticommonsense
# Usage: bash finetune/scripts/intervention_evals/eval_22_insert_wrong.sh

TEMPLATES=$(dirname "$0")
WORKDIR=${WORKDIR:-$(cd "$(dirname "$0")/../.."; pwd)}
cd "$WORKDIR"

export INTERV_NAME="22_insert_wrong_answer_once_per_sentence"
export SPLITS_LIST="easy hard anticommonsense"

JOB_NAME="22_insert_wrong_answer_once_per_sentence"
