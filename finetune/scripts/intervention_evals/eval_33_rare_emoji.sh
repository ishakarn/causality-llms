#!/bin/bash
# Submission driver for: 33_insert_rare_emoji_blocks
# Splits: easy hard anticommonsense
# Usage: bash finetune/scripts/intervention_evals/eval_33_rare_emoji.sh

TEMPLATES=$(dirname "$0")
WORKDIR=/work/pi_jensen_umass_edu/ikarn_umass_edu/olmo_cladder_test
cd "$WORKDIR"

export INTERV_NAME="33_insert_rare_emoji_blocks"
export SPLITS_LIST="easy hard anticommonsense"

JOB_NAME="33_insert_rare_emoji_blocks"
