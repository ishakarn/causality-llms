#!/bin/bash
# Re-run OLMo-3.1-32B-Instruct BASE only on one split.
# Required env var: SPLIT

#SBATCH --job-name=base-o32b-base
...
#SBATCH --output=finetune/slurm_logs/%j_base_rerun_olmo32b_base_%x.out
#SBATCH --error=finetune/slurm_logs/%j_base_rerun_olmo32b_base_%x.err
