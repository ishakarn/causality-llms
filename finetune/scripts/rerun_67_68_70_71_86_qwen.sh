#!/bin/bash
# Re-run 67/68/70/71/86 for qwen3b base + lora on updated intervention files.

#SBATCH --job-name=rerun-qwen
...
#SBATCH --output=finetune/slurm_logs/%j_rerun_qwen.out
#SBATCH --error=finetune/slurm_logs/%j_rerun_qwen.err
...
echo "=== Done: 67/68/70/71/86 rerun for qwen3b ==="
