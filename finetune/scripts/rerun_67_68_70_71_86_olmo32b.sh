#!/bin/bash
# Re-run 67/68/70/71/86 for olmo32b base + lora on updated intervention files.

#SBATCH --job-name=rerun-olmo32b
...
#SBATCH --output=finetune/slurm_logs/%j_rerun_olmo32b.out
#SBATCH --error=finetune/slurm_logs/%j_rerun_olmo32b.err
...
echo "=== Done: 67/68/70/71/86 rerun for olmo32b ==="
