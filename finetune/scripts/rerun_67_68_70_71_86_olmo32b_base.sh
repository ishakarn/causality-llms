#!/bin/bash
# Re-run 67/68/70/71/86 for olmo32b BASE ONLY on updated intervention files.

#SBATCH --job-name=rerun-olmo32b-base
...
#SBATCH --output=finetune/slurm_logs/%j_rerun_olmo32b_base.out
#SBATCH --error=finetune/slurm_logs/%j_rerun_olmo32b_base.err
...
echo "=== Done: 67/68/70/71/86 rerun olmo32b base ==="
