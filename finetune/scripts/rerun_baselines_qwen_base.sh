#!/bin/bash
# Re-run Qwen2.5-3B-Instruct BASE only on one split.
# Required env var: SPLIT

#SBATCH --job-name=base-qwen-base
#SBATCH --partition=gpu-preempt
#SBATCH --qos=normal
#SBATCH --gpus=1
#SBATCH --constraint="a16|a40|a100|l40s"
#SBATCH --cpus-per-task=4
#SBATCH --mem=24G
#SBATCH --time=00:20:00
#SBATCH --output=finetune/slurm_logs/%j_base_rerun_qwen_base_%x.out
#SBATCH --error=finetune/slurm_logs/%j_base_rerun_qwen_base_%x.err
