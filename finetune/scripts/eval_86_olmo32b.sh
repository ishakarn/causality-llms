#!/bin/bash
# Eval 86_nonsense_replace for olmo32b base + lora (easy/hard/anticommonsense).

#SBATCH --job-name=86-olmo32b
...
#SBATCH --output=finetune/slurm_logs/%j_86_olmo32b.out
#SBATCH --error=finetune/slurm_logs/%j_86_olmo32b.err
...
INTERVENTIONS=(86_nonsense_replace)
...
echo "=== Done: 86_nonsense_replace for olmo32b ==="
