#!/bin/bash
# Eval 86_nonsense_replace for qwen3b base + lora (easy/hard/anticommonsense).

#SBATCH --job-name=86-qwen
...
#SBATCH --output=finetune/slurm_logs/%j_86_qwen.out
#SBATCH --error=finetune/slurm_logs/%j_86_qwen.err
...
echo "=== Done: 86_nonsense_replace for qwen3b ==="
